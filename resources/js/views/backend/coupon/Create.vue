<template lang="">
    ...
    <ol class="breadcrumb float-xl-end">
    	<li class="breadcrumb-item"><a href="javascript:;">新增優惠券</a></li>
    	<li class="breadcrumb-item active">促銷管理</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">新增優惠券<small></small></h1>
    <!-- END page-header -->
    <!-- BEGIN panel -->
    <panel>
        <panel-body>
            <p class="text-invers" style="margin-bottom: 5px"><i class="fas fa-bullhorn fa-fw"></i>&nbsp;請點擊下方按鈕新增優惠券</p>
            <button type="submit" class="col-md-6 btn btn-primary w-100px" @click="submit()">新增優惠券</button>
        </panel-body>
    </panel>
    <panel>
        <panel-body>
            ...
            <div class="col-md-12">
                <input class="form-control" placeholder="請輸入優惠券名稱" v-model="couponData.name"/>
            </div>
...
<script setup>
    ...
    function submit() {
        ...
        couponStore.fetchCreateCoupon(data).then((response) => {
            if(response) {
