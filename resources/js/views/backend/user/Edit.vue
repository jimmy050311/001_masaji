<template lang="">
    ...
    <ol class="breadcrumb float-xl-end">
    	<li class="breadcrumb-item"><a href="javascript:;">編輯會員</a></li>
    	<li class="breadcrumb-item active">會員管理</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">編輯會員<small></small></h1>
    <!-- END page-header -->
    <!-- BEGIN panel -->
    <panel>
        <panel-body>
...
<script setup>
    ...
    onMounted(async() => {
        await levelStore.fetchObtainLevel().then((response) => {
            levelOptions.value = response
        })
        await userStore.fetchUserDetail(userId.value).then((response) => {
            ...
            userData.level_id = response.level_id
        })
    })
